...
STATE * fsm(STATE * p_tabla_estado,
            eventos evento_actual) { // Puntero al estado actual , Evento recibido
    // 1-Recorremos las tabla de estado ( Ej estado_0) hasta encontrar el arco que contenga el
    // evento actual
